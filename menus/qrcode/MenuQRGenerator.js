...
import {Button, Icon, Input, Dialog} from 'react-native-elements';
...
const MenuQRGenerator = () => {
  // menginisialisasi nilai awal menggunakan useState
  const [QRvalue, setQRValue] = useState('inixindo');
      ...
      <Input
        ...
        leftIcon={
          <Icon
            ...
            type="material"
            size={24}
            color={'rgba(70, 132, 153,1)'}
          />
        }
      />
      <QRCode
        value={QRvalue ? QRvalue : 'inixindo'}
        size={200}
        // logo={{uri: yourqrlogo}}
        logoSize={60}
